            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    <span className="font-medium text-dark">{product.overAllRating} Rating</span>
              ...
              <p className="prose prose-sm max-w-none text-gray-800 line-clamp-5" dangerouslySetInnerHTML={{ __html: product?.description }}>
