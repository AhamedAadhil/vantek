...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#ffffff] min-h-[270px] mb-4 shadow-3">
        <Image src={item?.images[0]} alt={item.name} width={250} height={250} />
