...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Banner', icon: MessageSquare, link: '/adminBanner' },
  ...
  return (
    <aside className="w-64 min-h-screen bg-dark-2 text-white p-4 flex flex-col">
      {/* Logo */}
    ...
    <li key={index}>
      {item.name === "Logout" ? (
        <button
          ...
          className={`w-full flex items-center space-x-3 p-3 rounded-lg transition-all hover:bg-meta-4 text-left ${
