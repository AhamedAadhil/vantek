  ...
  return (
    <div className="w-full h-full bg-gray-7 text-white p-4 rounded-lg shadow-lg">
      <div className="flex justify-between items-center mb-4 border-b border-gray-5 pb-2">
        <h2 className="text-lg font-semibold border-l-4 border-l-blue-500 pl-2">Top Customers</h2>
        ...
        {customers.map((customer) => (
          ...
          >
            <div className="flex items-center space-x-3">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center ${customer.bgColor}`}>
                <span className={`text-xs font-medium ${customer.textColor}`}>{customer.initials}</span>
              </div>
              <div>
