...
const ProductList = () => {
  ...
  return (
    <div className="m-4 p-6 bg-dark text-white rounded-lg">
      ...
      <table className="w-full text-left border-collapse">
        ...
        <tbody>
                    {currentProducts.map(product => (
                        <tr key={product.id} className="border-b border-dashed border-gray-700">
                            <td className="p-3">
                                <input
                                    type="checkbox"
                            ...
                            <td className="p-3 flex items-center space-x-3">
                                <Image src={product.Image} alt={product.product} width={40} height={40} className="rounded-full" />
      ...
      <div>
        <div className='mt-4'>
                <button className="mt-6 bg-red-light-3 hover:bg-red-dark text-dark hover:text-white font-semibold px-6 py-2 border-hidden rounded"
                    disabled={selectedProducts.length === 0}
                >
