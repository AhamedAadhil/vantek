    ...
    <>
      <div className="flex justify-start">
        <button
          ...
          className="flex items-center bg-teal-700 hover:bg-teal-900 text-white px-4 py-2 ml-4 mt-4 rounded"
        >
          <ArrowLeft size={16} className="mr-2" /> Back
        </button>
        <div className="bg-teal-700 text-white px-4 py-2 ml-4 mt-4 mr-4 rounded w-full text-center text-lg">
          ORDER DETAILS
        </div>
      </div>
    ...
    `}
        ...
        <div className="col-span-2 row-span-5 col-start-5 p-4">
          ...
          <div className="w-full mt-4 bg-[#1f1f1f] rounded-md border border-dashed border-gray-700 p-4 text-blueGray-300 text-sm">
            ...
            <p>
              Shipping:{" "}
              <span className="opacity-75">{order.shippingMethod}</span>
            </p>
            {order.trackingId && (
              <p>
                Tracking ID:{" "}
