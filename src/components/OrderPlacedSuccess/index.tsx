...
const OrderPlacedSuccess = () => {
  return (
    <>
      <Breadcrumb title={"OrderSuccess"} pages={["OrderSuccess"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Thank you for your order! Your purchase was successful and we’re
                getting it ready for delivery. You’ll receive a confirmation
                email shortly.
              </p>
