...
const shopData: Product[] = [
  {
    title: "Fridge Freezer Alpicool TWW35 35L",
    description:"Transporter HQ – Fridge Freezer – Alpicool TWW35 – 35L – Portable – Battery Powered – 12v/24v – Mains Charging – With LG Compressor", 
    reviews: 15,
    price: 59.0,
    ...
    imgs: {
      thumbnails: [
        "/images/products/product-gen-sm-1.png",
        "/images/products/product-gen-sm-1.png",
      ],
      previews: [
        "/images/products/product-gen-bg-1.png",
        "/images/products/product-gen-bg-1.png",
      ],
    },
  },
